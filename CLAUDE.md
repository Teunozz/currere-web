...
## Active Technologies
- PHP 8.4 + TypeScript 5.7 + Laravel 12, Inertia 2, Svelte 5, Fortify, Sanctum, Laravel AI SDK, LayerChart v2, qrcode (npm) (001-currere-web-app)
- SQLite (development), PostgreSQL or MySQL (production) (001-currere-web-app)

## Recent Changes
- 001-currere-web-app: Added PHP 8.4 + TypeScript 5.7 + Laravel 12, Inertia 2, Svelte 5, Fortify, Sanctum, Laravel AI SDK, LayerChart v2, qrcode (npm)
